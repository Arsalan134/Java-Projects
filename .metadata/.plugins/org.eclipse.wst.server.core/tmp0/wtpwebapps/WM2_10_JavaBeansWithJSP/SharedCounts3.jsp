...
<BODY>
	<TABLE BORDER=5 ALIGN="CENTER">
		<TR>
			<TH CLASS="TITLE">Shared Access Counts: Page 3
	</TABLE>
	<P>
		...
		Of SharedCounts3.jsp (this page), <A HREF="SharedCounts1.jsp">SharedCounts1.jsp</A>,
		and <A HREF="SharedCounts2.jsp">SharedCounts2.jsp</A>,
