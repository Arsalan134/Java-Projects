...
public class Line extends JFrame implements GLEventListener, KeyListener {
	...
	public void init(GLAutoDrawable drawable) {
		...
		// skydomeTexture.setTexParameteri(gl, GL2.GL_TEXTURE_MIN_FILTER,
		// GL2.GL_POINT);
		// skydomeTexture.setTexParameteri(gl, GL2.GL_TEXTURE_MAG_FILTER,
		// GL2.GL_POINT);
		// skydomeTexture.setTexParameteri(gl, GL2.GL_TEXTURE_WRAP_S,
		// GL2.GL_CLAMP_TO_EDGE);
		// skydomeTexture.setTexParameteri(gl, GL2.GL_TEXTURE_WRAP_T,
		// GL2.GL_CLAMP_TO_EDGE);
	...
	public void display(GLAutoDrawable drawable) {
		...
		TextureCoords texCoords = skydomeTexture.getImageTexCoords();
	...
	private void loadSkydomeTexture() {
		try {
			File skydomeImageFile = new File("src/cube.bmp");
