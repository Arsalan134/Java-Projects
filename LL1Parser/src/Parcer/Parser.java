...
public class Parser {
	...
	private void performParsingAlgorithm() {
		...
		do {
			...
			if (stackTop.isTerminal())
				if (stackTop.equals(inputTop)) {
					...
					System.err.println("Syntax error after token #" + parsedTokensCount);
			else {
	...
	private void follow(NonTerminal s, Symbol caller, Map<SimpleEntry<Symbol, Symbol>, Boolean> callTable) {
